...
Normalisering så har jag siktat på 3NF. Den viktigaste delen är kopplingstabellen OrderItems som hanterar många-till-många-relationen mellan order och produkt. Jag bröt även ut kategorier för att slippa dubbellagring av data.
